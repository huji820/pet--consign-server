...
public class Business2 {
    ...
    public Business2(String businessNo, String businessName,
    ...
    public Business2(Business business) {
        ...
        this.startHours = business.getStartHours();
        this.endHours = business.getEndHours();
        this.contact = business.getContact();
        this.contactPhone = business.getContactPhone();
        this.password = business.getPassword();
        this.describe = business.getDescribe();
        this.payBond = business.getPayBond();
        this.authType = business.getAuthType();
        this.fans = business.getFans();
        this.longitude = business.getLongitude();
        this.latitude = business.getLatitude();
        this.province = business.getProvince();
        this.city = business.getCity();
        this.area = business.getArea();
        this.detailAddress = business.getDetailAddress();
        this.headImg = business.getHeadImg();
        this.state = business.getState();
        this.unionId = business.getUnionId();
        this.power = business.getPower();
        this.followQty = business.getFollowQty();
        this.complete = business.getComplete();
        this.credit = business.getCredit();
        this.level = business.getLevel();
        this.customerNo = business.getCustomerNo();
        this.weChatImg = business.getWeChatImg();
        this.shopImages = business.getBusinessNo();
        this.openid = business.getUnionId();
    }
    ...
    public static class Builder {
        ...
        public Business2 buildBusiness() {
            return new Business2(this.businessNo, this.businessName,
